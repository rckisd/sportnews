# Generated by Django 4.1.13 on 2025-05-25 15:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score_a', models.PositiveSmallIntegerField(default=0, verbose_name='Счёт команды A')),
                ('score_b', models.PositiveSmallIntegerField(default=0, verbose_name='Счёт команды B')),
                ('date_time', models.DateTimeField(verbose_name='Дата и время матча')),
                ('status', models.CharField(choices=[('upcoming', 'Предстоящий'), ('live', 'В прямом эфире'), ('finished', 'Завершенный')], default='upcoming', max_length=10, verbose_name='Статус')),
                ('tournament', models.CharField(blank=True, max_length=200, verbose_name='Турнир')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.article', verbose_name='Новость')),
                ('event', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.event', verbose_name='Событие')),
                ('match', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.match', verbose_name='Матч')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
            ],
        ),
        ...
        migrations.AddConstraint(
            model_name='comment',
            constraint=models.CheckConstraint(check=models.Q(models.Q(('article__isnull', False), ('event__isnull', True), ('match__isnull', True)), models.Q(('article__isnull', True), ('event__isnull', False), ('match__isnull', True)), models.Q(('article__isnull', True), ('event__isnull', True), ('match__isnull', False)), _connector='OR'), name='check_comment_target'),
        ),
    ]
